...
// دالة عامة لاختيار ورفع الصور لـ Firebase Storage
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        fit: StackFit.expand,
        children: [
          // تم استخدام صورة احترافية من الهاتف (Assets) تعبر عن الجزائر
          ...
          child: Column(
            children: [
                ...
                currentAccountPicture: GestureDetector(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        bottom: 0, right: 0,
                        child: CircleAvatar(radius: 12, backgroundColor: Colors.black87, child: Icon(Icons.camera_alt, size: 14, color: Color(0xFFD4AF37))),
                      )
                    ],
                  )
                ),
              ...
              ListTile(
                ...
                title: Text(isArabic ? 'تغيير صورة الحساب من المعرض' : 'Changer la photo (Galerie)'),
                onTap: () {
        ...
        return SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            ...services.asMap().entries.map((e) {
              int idx = e.key;
              return GestureDetector(
                onTap: () => _showServiceDialog(services, index: idx), // تعديل الخدمة عند الضغط عليها
                child: Container(
            ...
            ElevatedButton.icon(
              ...
              onPressed: () => _showServiceDialog(services), // إضافة خدمة جديدة
